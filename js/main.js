!(function (t) {
  ...
  function (t, n, r) {
    ...
    if (r(8)) {
      var e = r(30),
        ...
        Ct = function (t, n) {
          return Bt(t, (n = m(n, !0))) ? l(2, t[n]) : q(t, n);
        },
        Ut = function (t, n, r) {
          return !(Bt(t, (n = m(n, !0))) && w(r) && b(r, "value")) ||
            b(r, "get") ||
            b(r, "set") ||
            r.configurable ||
        ...
        (t.exports = function (t, n, r, a) {
          ...
          b
            ? ((v = r(function (t, r, e, o) {
                ...
                if (w(r)) {
                  if (
                    ...
                    return bt in r ? Ft(v, r) : Tt.call(v, r);
                  (i = r), (p = Et(e, n));
                  var g = r.byteLength;
                  if (void 0 === o) {
            ...
            : (i(function () {
              ...
              X(m !== Function.prototype ? A(g).concat(A(m)) : A(g), function (
                t
              ) {
                t in v || h(v, t, g[t]);
              }),
  ...
  function (t, n, r) {
    ...
    function q(t, n, r, e, o, i) {
      ...
      for (var c = t[M]._b, a = u + t[j], s = e(+o), f = 0; f < n; f++)
        c[a + f] = s[i ? f : n - f - 1];
    }
    if (u.ABV) {
      if (
  ...
  function (t, n, r) {
    ...
    var e = r(1),
      ...
      z =
        ...
        s(function () {
          ...
          ? function (t, n, r) {
              var e = T(q, n);
              e && delete q[n], j(t, n, r), e && t !== q && j(q, n, e);
            }
          : j,
      Y = function (t) {
      ...
      Z = function (t, n) {
        if (((t = w(t)), (n = S(n, !0)), t !== q || !o(U, n) || o(W, n))) {
          var r = T(t, n);
          return (
      ...
      tt = function (t) {
        for (
          var n, r = t === q, e = L(r ? W : w(t)), i = [], u = 0;
          e.length > u;

        )
          !o(U, (n = e[u++])) || (r && !o(q, n)) || i.push(U[n]);
        return i;
      };
    G ||
      (c(
        (I = function () {
          ...
          return i && H && z(q, t, { configurable: !0, set: n }), Y(t);
        }).prototype,
        "toString",
        function () {
          return this._k;
      ...
      (r(45).f = J),
      (P.f = tt),
      i && !r(30) && c(q, "propertyIsEnumerable", J, !0),
      (v.f = function (t) {
        return Y(p(t));
      })),
    ...
    for (
      ...
      p(nt[rt++]);
    for (var et = M(p.store), ot = 0; et.length > ot; ) d(et[ot++]);
    u(u.S + u.F * !G, "Symbol", {
      for: function (t) {
    ...
    u(u.S + u.F * it, "Object", {
      ...
      I.prototype[D] || r(14)(I.prototype, D, I.prototype.valueOf),
      l(I, "Symbol"),
      l(Math, "Math", !0),
      l(e.JSON, "JSON", !0);
  },
      ...
      return [
        ...
        function (t, n) {
          ...
          for (var x, w = "", S = 0, _ = 0; _ < m.length; _++) {
            ...
            O >= S && ((w += h.slice(S, O) + T), (S = O + E.length));
          }
          return w + h.slice(S);
        },
      ];
  ...
  function (t, n, r) {
    ...
    var e,
      ...
      b = (t.exports = r(58)("WeakMap", g, m, s, !0, !0));
    h &&
      p &&
      (a((e = s.getConstructor(g, "WeakMap")).prototype, m),
      (c.NEED = !0),
  ...
  function (t, n, r) {
    for (
      ...
      var y,
        ...
        b = u[g],
        x = b && b.prototype;
      if (x && (x[f] || c(x, f, h), x[l] || c(x, l, g), (a[g] = h), m))
    ...
    function O(t, n) {
      return new Promise(function (r, e) {
        ...
        if (o.signal && o.signal.aborted)
          return e(new E("Aborted", "AbortError"));
  ...
  function (t, n, r) {
    ...
    function e(t, n) {
      const r = document.documentElement,
        ...
        o = (i) => {
          t.contains(i.target) ||
            (t.removeAttribute("data-event-fora"),
            e.forEach((t) => {
              r.removeEventListener(t, o);
            }),
            n());
        };
      t.hasAttribute("data-event-fora") ||
        (e.forEach((t) => {
          setTimeout(() => {
            r.addEventListener(t, o);
          });
        }),
        t.setAttribute("data-event-fora", ""));
    }
    function o() {
      const t = document.querySelectorAll('[data-numero="quantidade"]');
      let n;
      if (
        ...
        const t = document.querySelector(".quantidade");
        n.observe(t, { attributes: !0 });
      }
    }
    r.r(n),
      (function () {
        const t = document.querySelectorAll('[data-anime="menu"] a[href^="#"'),
          n = (t) => {
            t.preventDefault();
      ...
      (function () {
        const t = document.querySelectorAll('[data-anime="animais-lista"] li'),
      ...
      (function () {
        const t = document.querySelectorAll('[data-anime="faq"] dt');
        t.length &&
          ...
          t.forEach((t) => {
            t.addEventListener("click", () => {
              var n;
              (n = t).classList.toggle("ativo"),
                n.nextElementSibling.classList.toggle("ativo");
            });
          }));
      })(),
      (function () {
        const t = document.querySelectorAll('[data-anime="conteudo"]'),
          n = 0.7 * window.innerHeight,
          r = () => {
            t.forEach((t) => {
              t.getBoundingClientRect().top - n < 0 && t.classList.add("ativo");
            });
          };
        t.length && (r(), window.addEventListener("scroll", r));
      })(),
      (function () {
        const t = document.querySelector('[data-modal="login"'),
          n = document.querySelector('[data-modal="fechar"'),
          r = document.querySelector('[data-modal="container"]'),
          e = document.querySelector('[data-modal="button"]'),
          o = ["click", "touchstart"],
          i = (t) => {
      ...
      (function () {
        const t = document.querySelectorAll('[data-tooltip="informacao"]'),
          n = {
            handleEvent(t) {
              (this.varTooltip.style.top = t.pageY + 20 + "px"),
                (this.varTooltip.style.left = t.pageX + 20 + "px");
            },
          },
          r = {
            handleEvent() {
              this.varTooltip.remove(),
          ...
          e = (t, e) => {
            const o = ((t) => {
              ...
              return (n.innerText = r), document.body.appendChild(n), n;
            })(e);
            (o.style.top = t.pageY + 20 + "px"),
              (o.style.left = t.pageX + 20 + "px"),
              (r.element = e),
              (r.varTooltip = o),
      ...
      (function () {
        const t = document.querySelectorAll('[data-dropdown="menu"'),
          n = ["touchstart", "click"];
        t.forEach((t) => {
          n.forEach((n) => {
      ...
      (function () {
        const t = document.querySelector('[data-menu="mobile'),
          n = document.querySelector('[data-menu="list"'),
          r = () => {
            t.classList.toggle("ativo"),
              n.classList.toggle("ativo"),
              e(n, () => {
                t.classList.remove("ativo"), n.classList.remove("ativo");
              });
          };
        t &&
      ...
      (function () {
        ...
        if (t) {
          const n = t.dataset.semana.split(",").map(Number),
            r = t.dataset.horario.split(",").map(Number),
            e = new Date(),
            o = e.getDay(),
            i = e.getMinutes(),
            u = `${e.getUTCHours() - 3}.${i}`;
          n.indexOf(o) && +u >= r[0] && +u <= r[1]
            ? t.classList.add("aberto")
            : t.classList.add("fechado");
        }
      })(),
      (function () {
        const t = document.querySelector(".quantidade-grid");
        t &&
          (async function (n) {
            try {
              (await (await fetch(n)).json()).forEach((n) => {
                const r = ((t) => {
                  const n = document.createElement("div");
                  return (
                    n.classList.add("quantidade-animal"),
                    (n.innerHTML = `<h2> ${t.especie} </h2> <span data-numero="quantidade"> ${t.quantidade} </span>`),
                    n
                  );
                })(n);
                t.appendChild(r);
          ...
          })("../../json/animais-api.json");
      })(),
      (function () {
        const t = document.querySelector('[data-bitcoin="doacao"]');
        t &&
          (async function (n) {
            try {
              const r = await (await fetch(n)).json();
              t.innerText = (100 / r.BRL.buy).toFixed(4);
            } catch (t) {
              console.log(Error(t));
            }
